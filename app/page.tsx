      ...
      <section className="relative overflow-hidden border-b border-slate-200/60 bg-gradient-to-b from-white to-slate-50/80">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 py-10 sm:py-16 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            {/* Right column — documentation iframe */}
            <div className="hidden lg:block">
              <div className="relative rounded-xl border border-slate-200/80 bg-white shadow-lg overflow-hidden">
                ...
                <div className="flex items-center gap-2 border-b border-slate-100 bg-slate-50/80 px-4 py-2.5">
                  ...
                  <div className="flex-1 rounded-md bg-white border border-slate-200 px-3 py-1 text-[11px] text-slate-400 font-mono truncate">
                    Intorduction to Auto i18n for Spring Boot
                  </div>
                </div>
                <iframe
                  width="560"
                  height="315"
                  /// Change to youtube url of smarti18nauto
                  src="https://www.youtube.com/embed/qjvw7z7avpo?si=noEJYgmo-k8dIEy7"
